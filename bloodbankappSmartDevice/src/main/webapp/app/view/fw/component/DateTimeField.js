 ...
 */
Ext.define('Bloodbankapp.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Bloodbankapp.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Bloodbankapp.view.fw.component.DateTimePicker(o);
    },
