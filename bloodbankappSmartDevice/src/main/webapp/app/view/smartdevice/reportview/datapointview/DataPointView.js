Ext.define('Bloodbankapp.view.smartdevice.reportview.datapointview.DataPointView', {
	extend : 'Ext.panel.Panel',
	requires:['Bloodbankapp.view.smartdevice.reportview.datapointview.DataPointViewController'],
