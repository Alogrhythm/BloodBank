Ext.define('Bloodbankapp.view.smartdevice.reportview.chartview.ChartView', {
	extend : 'Ext.panel.Panel',
	requires:['Bloodbankapp.view.smartdevice.reportview.chartview.ChartViewController'],
