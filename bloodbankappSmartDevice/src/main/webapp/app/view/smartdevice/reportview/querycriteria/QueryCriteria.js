Ext.define('Bloodbankapp.view.smartdevice.reportview.querycriteria.QueryCriteria', {
	extend : 'Ext.panel.Panel',
	requires:['Bloodbankapp.view.smartdevice.reportview.querycriteria.QueryCriteriaController'],
