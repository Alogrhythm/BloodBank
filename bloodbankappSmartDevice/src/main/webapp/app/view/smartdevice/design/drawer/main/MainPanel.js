Ext.define('Bloodbankapp.view.smartdevice.design.drawer.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Bloodbankapp.view.googlemaps.map.MapPanel','Bloodbankapp.view.smartdevice.searchengine.SearchEngineMainView','Bloodbankapp.view.smartdevice.design.drawer.main.MainPanelController','Bloodbankapp.view.smartdevice.design.resource.AppFormsList'],
    userinfo:{},
    id:'mainPanel',
