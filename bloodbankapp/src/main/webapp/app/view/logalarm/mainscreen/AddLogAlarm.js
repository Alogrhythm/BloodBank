 ...
 * 
 */
Ext.define('Bloodbankapp.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Bloodbankapp.view.logalarm.mainscreen.AddLogAlarmController',
			'Bloodbankapp.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Bloodbankapp.view.logalarm.mainscreen.AppAlarmPanel',
