 ...
 * 
 */
Ext.define('Bloodbankapp.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.logAlarmMainViewTabPanelController',
	
	init : function()
	{
		var component = Ext.create("Bloodbankapp.view.logalarm.mainscreen.AddLogAlarm", {
			title : "",
		});
