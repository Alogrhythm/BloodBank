 ...
 * 
 */
Ext.define('Bloodbankapp.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Bloodbankapp.view.logalarm.LogAlarmMainViewController',
			'Bloodbankapp.view.logalarm.tree.LogAlarmTreePanel',
			'Bloodbankapp.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
