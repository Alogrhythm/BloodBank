Ext.define('Bloodbankapp.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Bloodbankapp.view.searchengine.search.NorthPanel', 'Bloodbankapp.view.searchengine.search.SearchResult','Bloodbankapp.view.searchengine.search.SearchEngineMainPanelController'],
