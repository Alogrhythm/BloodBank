Ext
		.define(
				'Bloodbankapp.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Bloodbankapp.view.searchengine.search.SearchEngineMainPanelController','Bloodbankapp.view.searchengine.search.PanelHeaderField' ,'Bloodbankapp.view.searchengine.search.ReportGridView','Bloodbankapp.view.searchengine.search.ReportChartView','Bloodbankapp.view.searchengine.search.documentView','Bloodbankapp.view.searchengine.search.DouMeanView','Bloodbankapp.view.googlemaps.map.MapPanel'],
