Ext
		.define(
				'Bloodbankapp.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Bloodbankapp.view.searchengine.search.documentController',
							'Bloodbankapp.view.searchengine.search.RowExpander' ],
