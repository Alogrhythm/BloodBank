 ...
 * 
 */
Ext.define("Bloodbankapp.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Bloodbankapp.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
