Ext.define('Bloodbankapp.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Bloodbankapp.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Bloodbankapp.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Bloodbankapp.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Bloodbankapp.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Bloodbankapp.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Bloodbankapp.view.clouddrive.CloudDrive");
    },
    ...
    loadLangCombo : function(){
     ...
     onSearchClick : function(searchBtn){
        ...
        var searchView = this.pushViewInMainTab("Bloodbankapp.view.searchengine.search.SearchEngineMainPanel","Search Result","isSearchCmp","true");
