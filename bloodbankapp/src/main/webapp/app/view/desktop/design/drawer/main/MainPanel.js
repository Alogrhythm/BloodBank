Ext.define('Bloodbankapp.view.desktop.design.drawer.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Bloodbankapp.view.desktop.design.drawer.main.MainPanelController','Bloodbankapp.view.desktop.design.drawer.resource.AppFormsList'],
    userinfo:{},
    id:'mainPanel',
