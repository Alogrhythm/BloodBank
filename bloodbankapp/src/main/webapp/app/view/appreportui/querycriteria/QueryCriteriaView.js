Ext.define('Bloodbankapp.view.appreportui.querycriteria.QueryCriteriaView',{
	extend : 'Ext.panel.Panel',
	requires : [ 'Bloodbankapp.view.appreportui.querycriteria.QueryCriteriaViewController' ],
