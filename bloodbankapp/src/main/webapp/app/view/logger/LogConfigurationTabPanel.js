...
Ext
		.define(
				'Bloodbankapp.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Bloodbankapp.view.logger.tabs.details.DetailsTab',
							'Bloodbankapp.view.logger.tabs.fileconnector.FileConnectorTab',
							'Bloodbankapp.view.logger.tabs.dbconnector.DBConnectorTab',
							'Bloodbankapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Bloodbankapp.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Bloodbankapp.view.logger.LogConfigurationTabPanelController',
