 ...
 * 
 */
Ext.define('Bloodbankapp.view.logger.tabs.fileconnector.FileConnectorTab', {
	...
	requires : ['Bloodbankapp.view.logger.tabs.fileconnector.FileConnectorTabController'],
