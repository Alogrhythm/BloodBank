 ...
 * 
 */
Ext.define('Bloodbankapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Bloodbankapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
