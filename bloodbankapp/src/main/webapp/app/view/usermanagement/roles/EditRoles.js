Ext.define('Bloodbankapp.view.usermanagement.roles.EditRoles', {
	extend : 'Ext.panel.Panel',
	requires : [ 'Bloodbankapp.view.usermanagement.roles.EditRolesController', 'Ext.tree.plugin.TreeViewDragDrop' ],
