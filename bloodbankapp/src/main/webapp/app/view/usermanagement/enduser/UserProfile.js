Ext.define('Bloodbankapp.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Bloodbankapp.view.usermanagement.enduser.UserProfileController', 'Bloodbankapp.view.usermanagement.admin.AddUserDetailsViewModel', 'Bloodbankapp.model.AddUserDataModel' ],
