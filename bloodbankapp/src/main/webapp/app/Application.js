 ...
 */
Ext.define('Bloodbankapp.Application', {
	...
	requires : [ "Ext.data.Model","Ext.app.ViewModel","Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Bloodbankapp.view.databrowsercalendar.DBCalendar"],
	...
	stores : [ 'Bloodbankapp.store.QueryCriteriaWidgetsStore' ],
	...
	try{
		...
		if (responseText.alarm) {
			if (responseText.alarm.alarmID == "ABSAA254905401" && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Bloodbankapp.view.login.SessionLogin').center();
