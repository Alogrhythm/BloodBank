Ext.define('Bloodbankapp.bloodbankapp.web.com.controller.bloodbankboundedcontext.bloodbank.DonationTypeMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#DonationTypeForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#DonationTypeForm');
          var grid = this.view.down('#DonationTypeGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#DonationTypeForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#DonationTypeForm').down('#' + me.column.dataIndex + '').store;
