Ext.define('Bloodbankapp.bloodbankapp.web.com.controller.bloodbankboundedcontext.bloodbank.BloodRequestMainController', {
     extend: 'Bloodbankapp.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.BloodRequestMainController',
     init: function() {
          var form = this.view.down('#BloodRequestForm');
          form.reset();
          this.bldgLoad();
     ...
     bldgLoad: function() {
          ...
          Ext.Ajax.request({
               ...
               success: function(response, scope) {
                    var compRef = scope.sender.down('#bldg');
                    scope.sender.controller.assignAllComboData(scope.sender, 'bldg', response.responseText);
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#BloodRequestForm');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, opts) {
                    ...
                    var compRef = currentView.down('#BloodRequestTree');
