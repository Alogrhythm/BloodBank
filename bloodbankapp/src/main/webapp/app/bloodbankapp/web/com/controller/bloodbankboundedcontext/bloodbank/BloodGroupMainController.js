Ext.define('Bloodbankapp.bloodbankapp.web.com.controller.bloodbankboundedcontext.bloodbank.BloodGroupMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#BloodGroupForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#BloodGroupForm');
          var grid = this.view.down('#BloodGroupGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#BloodGroupForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#BloodGroupForm').down('#' + me.column.dataIndex + '').store;
