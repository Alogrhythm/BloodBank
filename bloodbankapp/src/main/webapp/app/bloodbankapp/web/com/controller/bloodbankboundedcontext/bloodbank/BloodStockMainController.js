Ext.define('Bloodbankapp.bloodbankapp.web.com.controller.bloodbankboundedcontext.bloodbank.BloodStockMainController', {
     extend: 'Bloodbankapp.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.BloodStockMainController',
     init: function() {
          var form = this.view.down('#BloodStockForm');
          form.reset();
          this.bloodgLoad();
     ...
     bloodgLoad: function() {
          ...
          Ext.Ajax.request({
               ...
               success: function(response, scope) {
                    var compRef = scope.sender.down('#bloodg');
                    scope.sender.controller.assignAllComboData(scope.sender, 'bloodg', response.responseText);
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#BloodStockForm');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, opts) {
                    ...
                    var compRef = currentView.down('#BloodStockTree');
