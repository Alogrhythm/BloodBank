...
import com.app.server.businessservice.organization.locationmanagement.SaveC;
...
public class CountryServiceImpl extends CountryService {
    ...
    public HttpEntity<ResponseBean> save(@RequestBody Country entity) throws Exception {
        com.spartan.pluggable.logger.alarms.AppAlarm appAlarm = Log.getAlarm("ORGLM247900200");
        ...
        savec.proSaveC(entity);
        responseBean.add("message", String.format(appAlarm.getMessage(), "SaveC", "proSaveC"));
        Log.out.println(appAlarm.getAlarmID(), runtimeLogInfoHelper.getRequestHeaderBean(), "com.app.server.businessservice.organization.locationmanagement.SaveC", "proSaveC");
