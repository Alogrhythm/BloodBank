...
@Repository
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "16", comments = "Repository for Address Transaction table", complexity = Complexity.MEDIUM)
