...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "25", comments = "ClinicalInfo", complexity = Complexity.LOW)
public class ClinicalInfo implements Serializable, CommonEntityInterface, Comparator<ClinicalInfo> {
    ...
    public void setTemprature(String _temprature) {
        if (_temprature != null) {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.bloodbankboundedcontext.bloodbank.ClinicalInfo other = (com.app.shared.bloodbankboundedcontext.bloodbank.ClinicalInfo) obj;
            if (clinicalInfoId == null) {
                return false;
