...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/WECNOSMAROXXSSTEDOW8IG/18D01ABF-F632-496A-B379-FC50EDEAB8C0/art/data
AST_DATA_PATH=/tmp/applifire/db/WECNOSMAROXXSSTEDOW8IG/18D01ABF-F632-496A-B379-FC50EDEAB8C0/ast/data
MYSQL=/usr/bin
...
$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$AST_DATA_PATH/ast_BloodStock_T.csv' into table ast_BloodStock_T FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";
